# International Phone (rl-intl-phone)

Open Source Angular plugin for entering and validating international mobile numbers. It adds a flag dropdown with country name, country phone code to any input provide validation and many customization. it's the upgrade version of `rl-intl-phone` and have been supporting stanalone component.
...
- Step 2 - Install the plugin.
  ```Node
    npm install rl-intl-phone --save
  ```
  ...
  ```
- Step 3 - Use the plugin by using selector - rl-intl-phone
  ```HTML
      <rl-intl-phone></rl-intl-phone>
  ```

For more detail please check the [Stackblitz Example](https://stackblitz.com/edit/rl-intl-phone-demo)

# Features -

- Customization in dropdown option. You can customize the dropdown option in following ways [See Demo Here](https://rl-intl-phone-demo.stackblitz.io/#multiple-options) -

  - Country flag with country phone code.
  - Country flag with country name.
  - Country flag with country phone code and country name.

- Customization in tooltip text. You can customize the tooltip of option and selected value in following ways [See Demo Here](https://rl-intl-phone-demo.stackblitz.io/#CustomizationTooltip)-
...
- Customization in ordering of the dropdown. Their are following order in which you can sort the dropdown [See Demo Here](https://rl-intl-phone-demo.stackblitz.io/#customizedOrdering)-

  - Country ISO code.
  - Country name.
  - Country phone code.

- Provide the search option in the dropdown. Search is application on country name, country iso code and country phone code. Also provide flag to show search or not. [See Demo Here](https://rl-intl-phone-demo.stackblitz.io/#CustomizationSearching)

- Provide the input masking according to the country phone format.

- Provide the output event which call when the input is filled completed according to input masking. [See Demo Here](https://rl-intl-phone-demo.stackblitz.io/#SampleInputValidation)
...
- Provide the input property to customize the country list in the dropdown. Their are following cases when you customize dropdown [See Demo Here](https://rl-intl-phone-demo.stackblitz.io/#CustomizationCountryList)-
...
- Provide the Reactive form support. [See Demo Here](https://rl-intl-phone-demo.stackblitz.io/#CustomizationReactiveForm)-
...
- **Show the selected country list.**
  ...
  ```HTML
  <rl-intl-phone [configurationOption]="configOption1" [countryList]="customCountryList1" ></rl-intl-phone>
  ```
...
- **Change in order of dropdown list.**
  ...
  ```HTML
  <rl-intl-phone [configurationOption]="configOption2"></rl-intl-phone>
  ```
...
- **Integrate the validation and set the value.**
  ...
  ```HTML
  <rl-intl-phone [configurationOption]="configOption1" (onIsRequiredChange)="requiredFlagChange($event)" (onNumberChange)="onNumberChage($event)" [numberTextValue]="NumberModel" [selectedCountryISOCode]="selectedCountryISOCode"></rl-intl-phone>
  ```
...
- **Integrate with reactive form.**
  ...
  ```HTML
    <form [formGroup]="sampleForm">
     <rl-intl-phone key="keyname" [configurationOption]="configOption1" formControlName="sampleReactiveControl" ></rl-intl-phone>
    </form>
  ```
